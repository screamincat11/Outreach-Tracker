...
class ColoredListsUsers
{
    ...
    private function sendVerificationEmail($email, $ver)
    {
        ...
        $transport = Swift_SmtpTransport::newInstance('ssl://smtp.gmail.com', 465)
            ->setUsername(MAIL_USER) // Your Gmail Username
            ->setPassword(MAIL_PASS); // Your Gmail Password
        // Mailer
        $mailer = Swift_Mailer::newInstance($transport);

        // Create the message

$messageBody = "You have a new account at Colored Lists!
...
Activate your account: http://localhost/Outreach/accountverify.php?v=$ver&e=$e
...
$messageBody = " We just heard you forgot your password! Bummer! To get going again,
head over to the link below and choose a new password.

Follow this link to reset your password:
http://localhost/Outreach/resetpassword.php?v=$ver&e=$e
...
www.ColoredLists.com";
        ...
        $message = Swift_Message::newInstance()
          ...
          // Give the message a subject
          ->setSubject('Outreach Tracker - Request to Reset Your Password')
