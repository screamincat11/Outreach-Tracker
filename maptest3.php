...
function overlayBuilder(overlayID, overlayDate, overlayTitle, overlayComments, vertexStr, overlayPurpose, overlayType) {
    var overlayCoords = unpackVertices(overlayType, vertexStr);
    ...
    augmentMapOverlay(overlayID, overlayTitle, overlayComments, overlayPurpose, overlayDate, tempOverlay); 
...
function initialize() {
    ...
    google.maps.event.addListener(drawingManager, 'overlaycomplete', function(e) {
        ...
        if (e.type != google.maps.drawing.OverlayType.MARKER) {
            ...
            setUpPoly(newShape);
            augmentMapOverlay(-1, "", "", selectedPurpose, dateString, newShape);
            ...
            newShape.type = e.type;
            setUpPoly(newShape);
            augmentMapOverlay(-1, "", "", "marker", dateString, newShape);
            setSelection(newShape);
            overlayArray.push(newShape);
        }
    });
